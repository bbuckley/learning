export const fields = {
  ...
  status: { align: 'center', sort_type: 'text', sortable: true, editable: true },
  ...
  bcd: { sort_type: 'date', sortable: true, editable: true },
  ...
  hir_age: { align: 'right', sort_type: 'number', sortable: true, editable: false },
  calc_age: { align: 'right', sort_type: 'number', sortable: true, editable: false },
};
